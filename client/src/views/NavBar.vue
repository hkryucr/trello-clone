<template>
  <div >
    <div class="navbar-container" v-on:click='closemodal()'>
            <div class='navbar-left'>
                <div v-on:click.stop="openmodal('modalmenu')" class='navbar-icon'><font-awesome-icon icon="th" :style="{ color: '#fff' }" class="icon" /></div>
            ...
            <div class="navbar-header">
                <svg v-on:click.stop='homepage()' style="top: 3.8px; left: 45%;" class="d-block" width="130" height="30" viewBox="0 0 885 272" alt="Trello">
                    <g fill-rule="evenodd">
            ...
            <div class="navbar-right">
                <div v-on:click.stop="openmodal('modalcreate')" class='navbar-icon'><font-awesome-icon icon="plus" class="icon" :style="{ color: '#fff' }"/></div>
                <div v-on:click.stop="openmodal('modalinformation')" class='navbar-icon'><font-awesome-icon icon="info-circle" class="icon" :style="{ color: '#fff' }"/></div>
                <div v-on:click.stop="openmodal('modalnotification')" class='navbar-icon'><font-awesome-icon icon="bell" class="icon" :style="{ color: '#fff' }"/></div>
                <span v-on:click.stop="openmodal('modalaccount')" class='navbar-user'>{{ this.initials }}</span>
            </div>
        <div v-bind:class=[getNavModal]>
