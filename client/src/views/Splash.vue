<template>
  <div class="splash">
    ...
    <section class="team">
      <div class="section-container" style="padding-top: 3rem">
        <div class="section-container-row">
          <div class="section-container-row-right">
        ...
        <div class="section-container-row">
          ...
          <div class="section-container-row-right">
            <img src="../assets/butler.png" style="width: 70%" alt="">
          </div>
        </div>
      </div>
    </section>
...
.section-container-row-left > h1 {
  font-size: 3rem;
  font-weight: bolder;
  line-height: 1.2;
  margin-bottom: 1rem;
}
.section-container-row-left > h3 {
  font-size: 2.2rem;
  font-weight: bolder;
  line-height: 1.2;
  margin-bottom: 1rem;
}
.section-container-row-left > p {
  font-size: 1.5rem;
  font-weight: 400;
  margin-bottom: 1rem;
}
.section-container-row-left > div,.section-container-row-left > ul {
  font-size: 1.25rem;
  font-weight: 500;
  margin-bottom: 1rem;
}
